...
document.addEventListener("DOMContentLoaded", () => {
  ...
  async function showManageExhibitions() {
   ...
   `;
    ...
    createExBtn.addEventListener("click", async () => {
      ...
      try {
        const res = await fetch("https://mlfz8c-5000.csb.app/api/exhibitions", {
          method: "POST",
        ...
        btn.addEventListener("click", async () => {
          ...
          try {
            const res = await fetch(
              `https://mlfz8c-5000.csb.app/api/exhibitions/${id}`,
              {
                method: "DELETE",
                headers: getAuthHeader(),
              }
  ...
  async function showManageLinks() {
   ...
   `;
    ...
    createLinkBtn.addEventListener("click", async () => {
      ...
      try {
        const res = await fetch("https://mlfz8c-5000.csb.app/api/links", {
          method: "POST",
          headers: getAuthHeader(),
          body: JSON.stringify(body),
        });
    ...
    function renderLinks(links) {
      ...
      delButtons.forEach((btn) => {
        btn.addEventListener("click", async () => {
          ...
          try {
            const res = await fetch(
              `https://mlfz8c-5000.csb.app/api/links/${id}`,
              {
                method: "DELETE",
                headers: getAuthHeader(),
              }
  ...
  function showPublicExhibitions(category) {
    ...
    fetch("https://mlfz8c-5000.csb.app/api/exhibitions")
      .then((res) => res.json())
      .then((exhibitions) => {
  ...
  function showPublicLinks(category) {
    ...
    fetch("https://mlfz8c-5000.csb.app/api/links")
      .then((res) => res.json())
      .then((links) => {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  signUpBtn.addEventListener("click", async () => {
    ...
    try {
      const response = await fetch(
        "https://mlfz8c-5000.csb.app/api/auth/signup",
        {
          method: "POST",
  ...
  signInBtn.addEventListener("click", async () => {
    ...
    try {
      const response = await fetch(
        "https://mlfz8c-5000.csb.app/api/auth/signin",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({ username, password }),
